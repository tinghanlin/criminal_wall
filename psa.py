import torch
import numpy as np
from moviepy.editor import VideoFileClip, clips_array, concatenate_videoclips,AudioFileClip,ImageClip
import subprocess
import os
import time
...
# if not using the deep fake comment out
...
def audio_psa(input,output):
    ...
    tts.tts_to_file("Your data is powerful. Protect it. Read before you agree. Think before you share.", speaker_wav=f"{input}", language="en", file_path=output)
...
def make_psa(out_path):
    ...
    audio = AudioFileClip("psa_audio.mp4")
    # Import the Image and set its duration same as the audio (Insert the location of your photo instead of photo.jpg)
    clip = ImageClip("assets/psa_word_pt_2.png").set_duration(audio.duration)
    # Set the audio of the clip
    clip = clip.set_audio(audio)
    # Export the clip
    clips = [frist_st_part,word_pt_1,clip, second_nd_part_psa]
...
concat_with_moviepy(video_paths,output_path)
# IF ffmpeg is better
#output_path = f"psa/2_part_psa_vids{datetime.datetime.now()}_2.mp4"
#concat_with_ffmpeg(video_paths, output_path)

# to use for trainning the deep fake
output_path = f"psa_audio.mp4"
audio_training = [
    "new_combined_1_no_silence_concat.mp4",
    "new_combined_2_no_silence_concat.mp4",
    "new_combined_3_no_silence_concat.mp4",
    "new_combined_4_no_silence_concat.mp4",
    "new_combined_5_no_silence_concat.mp4",
    "new_combined_6_no_silence_concat.mp4",
    "new_combined_7_no_silence_concat.mp4",
    "new_combined_8_no_silence_concat.mp4",
    "new_combined_9_no_silence_concat.mp4",
    "new_combined_10_no_silence_concat.mp4",
    "new_combined_11_no_silence_concat.mp4",
    "new_combined_12_no_silence_concat.mp4",
    "new_combined_13_no_silence_concat.mp4",
    "new_combined_14_no_silence_concat.mp4",
    "new_combined_15_no_silence_concat.mp4",
    "new_combined_16_no_silence_concat.mp4",
    "new_combined_17_no_silence_concat.mp4",
    "new_combined_18_no_silence_concat.mp4",
    "new_combined_19_no_silence_concat.mp4",
    "new_combined_20_no_silence_concat.mp4",
    "new_combined_21_no_silence_concat.mp4",
    "new_combined_22_no_silence_concat.mp4",
    "new_combined_23_no_silence_concat.mp4",
    "new_combined_24_no_silence_concat.mp4",
    "new_combined_25_no_silence_concat.mp4",
    "new_combined_26_no_silence_concat.mp4",
    "new_combined_27_no_silence_concat.mp4",
    "new_combined_28_no_silence_concat.mp4",
    "new_combined_29_no_silence_concat.mp4",
    "new_combined_30_no_silence_concat.mp4",
    "new_combined_31_no_silence_concat.mp4",
    "new_combined_32_no_silence_concat.mp4",
    "new_combined_33_no_silence_concat.mp4",
    "new_combined_34_no_silence_concat.mp4",
    "new_combined_35_no_silence_concat.mp4",
    "new_combined_36_no_silence_concat.mp4",
    "new_combined_37_no_silence_concat.mp4",
    "new_combined_38_no_silence_concat.mp4",
    "new_combined_39_no_silence_concat.mp4",
    "new_combined_40_no_silence_concat.mp4",
    "new_combined_41_no_silence_concat.mp4",
    "new_combined_42_no_silence_concat.mp4",
    "new_combined_43_no_silence_concat.mp4",
    "new_combined_44_no_silence_concat.mp4",
    "new_combined_45_no_silence_concat.mp4",
    "new_combined_46_no_silence_concat.mp4",
    "new_combined_47_no_silence_concat.mp4",
    "new_combined_48_no_silence_concat.mp4",
    "new_combined_49_no_silence_concat.mp4",
    "new_combined_50_no_silence_concat.mp4"
]

# make deepfake audio
make_deep_audio(audio_training,output_path)

output_path = f"psa_final_no_voice.mp4"
