...
class DissonanceApp(QWidget):
    def __init__(self):
        ...
        self.dynamic_labels = []  # Track dynamically created labels
        self.current_bg = None  # Track the current background (QMovie or QPixmap)
    ...
    def show_unit_page_with_gif(self, words, completion_callback):
        ...
        word_label.setFont(QFont("Helvetica", 36, QFont.Weight.Bold))
    ...
    def play_video(self, video_path, audio_path, callback):
        ...
        audio_thread.join()  # Ensure audio finishes playing
        callback()
